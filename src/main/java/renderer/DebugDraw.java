...
public class DebugDraw
{
    ...
    {
        addLine2D(from, to, new Vector3f(1.0f, 0.0f, 0.0f));
    }
    ...
    {
        addBox2D(center, dimensions, rotation, new Vector3f(0.0f, 1.0f, 0.0f));
    }
    ...
    {
        addCircle(center, radius, new Vector3f(0.0f, 0.0f, 1.0f));
    }
